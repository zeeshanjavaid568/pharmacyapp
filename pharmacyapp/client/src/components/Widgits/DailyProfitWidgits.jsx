...
const DailyProfitWidgits = ({ title, totalPrice, totalItems }) => {
    ...
    return (
        <div className="Widgits_wrapper">
            <div className="card form_div m-1" style={{ width: '22rem' }}>
                <div className="card-body">
                    <div className="d-flex justify-content-between align-items-center">
                        <h5 className="card-title gradient_text mb-0">{title}</h5>
                        <div
...
export default DailyProfitWidgits;