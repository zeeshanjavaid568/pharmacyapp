  ...
  return (
    <div className="card form_div mb-5 p-3 rounded-2 w-100">
      <form className="d-flex justify-content-between flex-wrap align-items-end" onSubmit={handleSubmit}>
        ...
        <div className="col-auto">
          <label className="me-2">Medicine Qty <span style={{ color: '#dc3545' }}>*</span></label>
          <input
            type="number"
            name="m_pieces"
            className="form-control p-1 my-2"
        ...
        {/* ✅ Feed Total Piece */}
        <div className="col-auto">
          <label className="me-2">Feed Qty <span style={{ color: '#dc3545' }}>*</span></label>
          <input
            type="number"
            name="total_piece"
            className="form-control p-1 my-2"
        ...
        {/* ✅ Other Total Piece */}
        <div className="col-auto">
          <label className="me-2">Other Qty <span style={{ color: '#dc3545' }}>*</span></label>
          <input
            type="number"
            name="o_pieces"
            className="form-control p-1 my-2"
        ...
        <div className="col-auto">
          <label className="me-2">Total Qty Price <span style={{ color: '#dc3545' }}>*</span></label>
        ...
        {/* ✅ Given Dues */}
        <div className="col-auto">
          <label className="me-2"> <span style={{ color: '#dc3545' }}>Debit (-) *</span></label>
          <input
            type="number"
            name="given_dues"
            className="form-control p-1 my-2"
        ...
        {/* ✅ Taken Dues */}
        <div className="col-auto">
          <label className="me-2"> <span style={{ color: '#157347' }}>Credit (+) </span><span style={{ color: '#dc3545' }}>*</span></label>
          <input
            type="number"
            name="taken_dues"
            className="form-control p-1 my-2"
        ...
        <div className="col-auto">
          <label className="me-2">Remains Total Balance (Auto) <span style={{ color: '#dc3545' }}>*</span></label>
          <input
            type="number"
            name="price"
