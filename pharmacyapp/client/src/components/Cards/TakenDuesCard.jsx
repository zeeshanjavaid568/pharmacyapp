...
import { useCreateTakenDuesMutation, useGetAllTakenDuesQuery } from '../../redux/features/DuesApi/takenDuesApi';
...
const TakenDuesCard = () => {
  ...
  const { refetch } = useGetAllTakenDuesQuery();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      swal.fire({
        title: 'Success',
        text: 'Taken Dues added successfully!',
        icon: 'success',
      ...
      swal.fire({
        title: 'Error!',
        text: 'Failed to add Taken Dues. Please try again.',
        icon: 'error',
        confirmButtonText: 'Ok',
        buttonsStyling: false,
      ...
      >
        ...
        <div className="col-aut mb-2">
          <button
            ...
            disabled={isLoading}
          >
            {isLoading ? 'Submitting...' : 'Add Taken Dues'}
          </button>
        </div>
      </form>
    </div>
