...
const SalerRecord = () => {
  const { data, isLoading, isError, } = useSalerProductQuery();
  ...
  return (
    <>
      <h1 className='d-flex justify-content-center my-4 gradient_text'>Saler All Years Record</h1>
        ...
        {!isLoading &&
          ...
          Object.keys(yearlyData).map((year) => (
            <div key={year} className='yearly_record_card border rounded-2 my-1 form_div'>
              <Link
                to={`/year-saler-record-detail/${year}`}
